...
public class AddFunctionParametersFix extends ChangeFunctionSignatureFix {
    ...
    @Override
    protected void invoke(@NotNull final Project project, Editor editor, final JetFile file) {
        final BindingContext bindingContext = ResolvePackage.getBindingContext((JetFile) callElement.getContainingFile());
