...
public class DefaultErrorMessagesJvm implements DefaultErrorMessages.Extension {
    ...
    static {
        ...
        MAP.put(ErrorsJvm.PLATFORM_STATIC_NOT_IN_OBJECT, "Only functions in objects and class class objects could be annotated with ''platformStatic''", DescriptorRenderer.SHORT_NAMES_IN_TYPES);
        MAP.put(ErrorsJvm.OVERRIDE_CANNOT_BE_STATIC, "Override cannot be static in object", DescriptorRenderer.SHORT_NAMES_IN_TYPES);
        MAP.put(ErrorsJvm.PLATFORM_STATIC_ILLEGAL_USAGE, "This declaration does not support static", DescriptorRenderer.SHORT_NAMES_IN_TYPES);
    }
